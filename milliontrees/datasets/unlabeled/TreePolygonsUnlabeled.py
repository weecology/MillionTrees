...
from milliontrees.datasets.unlabeled.milliontrees_unlabeled_dataset import milliontreesUnlabeledDataset
from milliontrees.common.grouper import CombinatorialGrouper
from milliontrees.common.metrics.all_metrics import Accuracy, Recall, F1


class TreePolygons_Unlabeled_Dataset(milliontreesUnlabeledDataset):
    """
