...
"""
    ...
    dataset_classes = {'TreePoints': {'labeled':
        'milliontrees.datasets.TreePoints.TreePointsDataset', 'unlabeled':
        'milliontrees.datasets.unlabeled.TreePointsUnlabeled.TreePoints_Unlabeled_Dataset'
        }, 'TreePolygons': {'labeled':
        ...
        'milliontrees.datasets.TreeBoxes.TreeBoxesDataset', 'unlabeled':
        'milliontrees.datasets.unlabeled.TreeBoxesUnlabeled.TreeBoxes_Unlabeled_Dataset'
        }}
    if dataset in dataset_classes:
        module_path = dataset_classes[dataset]['unlabeled' if unlabeled else
            'labeled']
